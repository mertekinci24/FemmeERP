...
/// <summary>
/// R-131: Cash Receipt Dialog (Tahsilat FiÅŸi) ViewModel
/// </summary>
public class CashReceiptDialogViewModel : ViewModelBase
{
    ...
    public CashReceiptDialogViewModel(ICashService cashService, IPartnerReadService partnerService)
    {
    ...
    private async Task SaveAsync()
    {
        ...
        try
        {
            ...
            await _cashService.CreateReceiptAsync(dto);
            DialogResult = true;
            OnRequestClose();
        }
        catch (Exception ex)
        {
            ErrorMessage = $"Tahsilat kaydedilemedi: {ex.Message}";
        }
    }
